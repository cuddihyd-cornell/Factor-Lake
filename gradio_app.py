...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        selected_sectors = gr.CheckboxGroup(label="Select Sectors", choices=SECTOR_OPTIONS)
    ...
    initial_aum = gr.Number(label="Initial AUM ($)", value=1000000, precision=2)
